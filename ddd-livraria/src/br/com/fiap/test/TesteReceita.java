...
public class TesteReceita {
    public static void main(String[] args) {
        ...
        boloFuba.setNomeReceita("Bolo de fuba");
        boloFuba.setAutorReceita("Ana Maria");
        boloFuba.setDificuldade("fácil");
        boloFuba.setPorcoes(8);
        boloFuba.setTempoPreparo(35);
        boloFuba.setDescricao("O bolo de fubá simples combina com um cafezinho no lanche da tarde. Fácil de preparar, " +
                "a receita leva menos de 10 ingredientes.");
        boloFuba.setIngredientes("1 xícara de chá de óleo\n" +
                "4 ovos\n" +
        ...
        boloFuba.setModoPreparo("Bata no liquidificador o óleo, ovos e a açúcar até ficar homogêneo. Depois, adicione leite e bata novamente .\n" +
                "2 " +
